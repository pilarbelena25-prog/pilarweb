            ...
            >
              ...
              <div className="w-48 h-48 mb-6 flex-shrink-0">
                <LazyImage
                  src={member.photo}
                  alt={member.alt}
                  className="w-full h-full rounded-full object-cover object-[50%_45%] ring-4 ring-primary/20 group-hover:ring-primary/40 transition-all duration-300 shadow-elegant"
                />
              </div>
