...
const Servicios = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Servicios de Consultoría SEO Fintech | Pilar Beleña</title>
        <meta name="description" content="Servicios de posicionamiento SEO y estrategia de contenidos con IA para Fintech, banca digital y sector inmobiliario en España. Auditoría SEO Express." />
        <meta name="keywords" content="Servicios SEO Fintech, Auditoría SEO express, posicionamiento buscadores financiero, SEO inmobiliario, consultoría SEO" />
        <link rel="canonical" href="https://pilar-belena-seo-fintech-lab.netlify.app/servicios" />
      </Helmet>
      ...
      <main>
        <section className="relative pt-32 pb-20 bg-gradient-hero overflow-hidden">
          ...
          <div
            ...
            style={{ backgroundImage: `url(${imgServiciosPortada})` }}
          />
